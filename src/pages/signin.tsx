...
const signin = () => {
  return (
    <div className="h-screen bg-gray-700 bg-no-repeat">
      <div
      ...
      >
        <div className="absolute top-[15rem] right-[14rem] h-full w-full max-w-md md:h-auto">
          <div className="relative rounded-lg bg-white shadow dark:bg-gray-900 ">
            ...
            <div className="px-6 py-6 lg:px-8">
              ...
              <form className="space-y-6" action="#">
                <button
                  type="button"
                  className="flex w-full items-center justify-center rounded-lg bg-blue-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >
                  <svg
                ...
                <div className="text-sm font-medium text-gray-500 dark:text-gray-300">
                  Explore the demo data as the guest.
                </div>
              </form>
            </div>
          </div>
